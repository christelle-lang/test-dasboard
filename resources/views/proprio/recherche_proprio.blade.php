...
<div class="QA_table mb_30">
    ...
    <table class="table lms_table_active3 ">
        ...
        <tbody>
            ...
            @foreach ($recherche_proprio as $recherche_proprios)
            <tr>
                <td>{{ $recherche_proprios->idProprio }}</td>
                <td>{{ $recherche_proprios->nomProrio }}</td>
                <td>{{ $recherche_proprios->prenomProrio }}</td>
                <td>{{ $recherche_proprios->emailProrio }}</td>
                <td>{{ $recherche_proprios->motDePasseProrio }}</td>
                <td>{{ $recherche_proprios->numTelProrio }}</td>
                <td>{{ $recherche_proprios->statut }}</td>
