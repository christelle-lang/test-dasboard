    ...
    <table class="table lms_table_active3 ">
        ...
        <thead>
            <tr>
                ...
                <th scope="col">date d'enlèvement</th>
                <th scope="col">date d'enlèvement</th>
                <th scope="col">type de la marchandise</th>
        ...
        <tbody>
            @foreach ($recherche_demande as $recherche_demandes)
            <tr>
                <td>{{ $recherche_demandes->idDemande }}</td>
                <td>{{ $recherche_demandes->idClient }}</td>
                <td>{{ $recherche_demandes->idCamion  }}</td>
                <td>{{ $recherche_demandes->poidsMarchandise  }}</td>
                <td>{{ $recherche_demandes->lieuEnlevement  }}</td>
                <td>{{ $recherche_demandes->lieuDestination }}</td>
                <td>{{ $recherche_demandes->dateEnlevement }}</td>
                <td>{{ $recherche_demandes->typeMarchandise }}</td>
                <td>{{ $recherche_demandes->statut }}</td>
