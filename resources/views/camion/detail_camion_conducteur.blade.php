                        ...
                        <div class="row mb-4">
                          <div class="card-header">
                            ...
                            <div class="col-sm-4 mt-4">
                                <div>Nom prénoms: {{$conducteur->nomConducteur}} {{$conducteur->prenomConducteur}}</div>
                              
                                
                                <div>Email: {{$conducteur->emailConducteur}}</div>
                                
                                <div>Numéro 1: {{$conducteur->numTelConducteur}}</div>
                                
                                <div>Numéro 2: {{$conducteur->numTelConducteur2}}</div>
                            ...
                            <div class="col-sm-4 mt-4">
                                @if (!empty($conducteur))
                                    @if (!empty($conducteur->photoCNI))  
                                <div id="carouselExampleFade" class="carousel slide carousel-fade " data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        @foreach( json_decode($conducteur->photoCNI) as $img)           
                                         <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                                            <div class="card" style="width: 18rem;">
                                                <p>Pièce d'identité</p>
                                                <img src="{{ asset($img) }}" class="card-img-top img-fluid" alt="...">
                                                <div class="card-body">
                                                    <p class="card-text">Date d'expiration:{{$conducteur->dateValiditeCNI}}</p>
                                                </div>
                                              </div>      
                                        </div>
                                      @endforeach
                            ...
                            <div class="col-sm-4 mt-4">
                                    @if (!empty($conducteur->photoPermis))  
                                    <div id="carouselExampleFade" class="carousel slide carousel-fade " data-bs-ride="carousel">
                                       <div class="carousel-inner">
                                         @foreach( json_decode($conducteur->photoPermis) as $img)           
                                          <div class="carousel-item {{ $loop->first ? 'active' : '' }} ">
                                             <div class="card" style="width: 18rem;">
                                                 <p>Permis de conduire</p>
                                                 <img src="{{ asset($img) }}" class="card-img-top img-fluid" alt="...">
                                                 <div class="card-body">
                                                     <p class="card-text">Date d'expiration:{{$conducteur->dateValiditePermis}}</p>
                                                 </div>
                                               </div>      
                                         </div>
                                       @endforeach
