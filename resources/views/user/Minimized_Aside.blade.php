...
<!-- Mirrored from demo.dashboardpack.com/user-management-html/Minimized_Aside.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Apr 2023 16:10:16 GMT -->
<head>
...
<nav class="sidebar mini_sidebar">
    <nav class="sidebar">
        ...
        <a class="large_logo" href="{{route('ndex_2')}}"><img src="img/logo.png" alt></a>
        <a class="small_logo" href="{{route('ndex_2')}}"><img src="img/mini_logo.png" alt></a>
